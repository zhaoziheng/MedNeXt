...
def evaluate(dataset):
    ...
    save_path = '/mnt/hwfile/medai/zhaoziheng/SAM/nnUNet_data/nnUNet_MedNeXt_raw/{}/labelsPred_MedNeXt_S_kernel3'.format(dataset)
    os.makedirs(save_path, exist_ok=True)

    seg_path = join('/mnt/hwfile/medai/zhaoziheng/SAM/nnUNet_data/nnUNet_MedNeXt_raw/{}/labelsPred_MedNeXt_S_kernel3'.format(dataset))
    gt_path = join('/mnt/hwfile/medai/zhaoziheng/SAM/nnUNet_data/nnUNet_MedNeXt_raw/{}/labelsTs'.format(dataset))
    csv_path = '/mnt/hwfile/medai/zhaoziheng/SAM/nnUNet_data/nnUNet_MedNeXt_raw/{}/labelsPred_MedNeXt_S_kernel3/{}_results.csv'.format(dataset, dataset)
